// Vilpe_control_v2.js
// Объект: 05_16_Iset
// Назначение: координация вытяжки Vilpe и режима сушки сауны
// Совместимость: wb-rules (ECMAScript 5)
...
var VC2_CFG = {
  ids: {
    userVdev: "vilpe_control_v2",
    userTitle: "Управление вытяжкой Vilpe",
    serviceVdev: "vilpe_control_v2_service",
    serviceTitle: "Сервис Vilpe / диагностика"
  },
...
function vc2ApplyFlags(flags, alarmText) {
  ...
  vc2Write(vc2ServiceCell("startup_diagnostics_error"), !!flags.startupDiagnosticsError);
...
defineVirtualDevice(VC2_CFG.ids.serviceVdev, {
  ...
  cells: {
    ...
    state_currents_missing_since_ts: {
      type: "value",
      value: 0,
      title: "state_currents_missing_since_ts",
      order: 95
    },
    state_humidity_mode_stable: {
      type: "text",
      value: "NORMAL",
      title: "state_humidity_mode_stable",
      order: 96
    },
    state_last_applied_vilpe_setpoint: {
      type: "value",
      value: -1,
      title: "state_last_applied_vilpe_setpoint",
      order: 97
    },
...
function vc2StartupDiagnostics() {
  ...
  if (errors.length > 0) {
    vc2Write(vc2ServiceCell("startup_diagnostics_error"), true);
    ...
    vc2Write(vc2ServiceCell("startup_diagnostics_error"), false);
