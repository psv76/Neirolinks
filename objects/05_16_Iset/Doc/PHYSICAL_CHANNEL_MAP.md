...
Два физических датчика WB-MSW в летней кухне и коридоре имеют одинаковый Modbus ID 53, но подключены к разным RS-485-портам. Поэтому их MQTT device/channel обозначения в таблице совпадают, а физическое различие задаётся портом и помещением.
...
| `wb-msw-v4_52` | WB-MSW v.4 | `/dev/ttyRS485-2` | 52 |
| `wb-msw-v4_53` — датчик летней кухни | WB-MSW v.4 | отдельный порт RS-485 | 53 |
| `wb-msw-v4_53` — датчик коридора | WB-MSW v.4 | другой порт RS-485 | 53 |
...
| `wb-msw-v4_53` | `wb-msw-v4_53/Air Quality (VOC)` | Климат на жилом этаже | Коридор качество воздуха (VOC) |
| `wb-msw-v4_53` | `wb-msw-v4_53/CO2` | Климат на жилом этаже | Коридор уровень CO₂ |
| `wb-msw-v4_53` | `wb-msw-v4_53/Current Motion` | Климат на жилом этаже | Коридор движение |
| `wb-msw-v4_53` | `wb-msw-v4_53/Humidity` | Климат на жилом этаже | Коридор влажность |
| `wb-msw-v4_53` | `wb-msw-v4_53/Illuminance` | Климат на жилом этаже | Коридор освещенность |
| `wb-msw-v4_53` | `wb-msw-v4_53/Temperature` | Климат на жилом этаже | Коридор температура |
| `wb-msw-v4_53` | `wb-msw-v4_53/Air Quality (VOC)` | Летняя кухня, отдельный порт RS-485 | Летняя кухня, качество воздуха (VOC) |
| `wb-msw-v4_53` | `wb-msw-v4_53/CO2` | Летняя кухня, отдельный порт RS-485 | Летняя кухня, уровень CO₂ |
| `wb-msw-v4_53` | `wb-msw-v4_53/Current Motion` | Летняя кухня, отдельный порт RS-485 | Летняя кухня, движение |
| `wb-msw-v4_53` | `wb-msw-v4_53/Humidity` | Летняя кухня, отдельный порт RS-485 | Летняя кухня, влажность |
| `wb-msw-v4_53` | `wb-msw-v4_53/Illuminance` | Летняя кухня, отдельный порт RS-485 | Летняя кухня, освещённость |
| `wb-msw-v4_53` | `wb-msw-v4_53/Temperature` | Летняя кухня, отдельный порт RS-485 | Летняя кухня, температура |
